...
export const getAllBranches = (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(successResponse(branches, "Branches retrieved successfully"));
};
...
export const getBranchById = (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(successResponse(branch, "Branch retrieved successfully"));
};
...
export const updateBranch = (req: Request, res: Response) => {
  ...
  res
    .status(200)
    .json(successResponse(branch, "Branch updated successfully"));
};
